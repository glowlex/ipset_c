...
@pytest.mark.parametrize("data, expected", [
    ...
    ((x for x in [str(ipaddress.IPv4Network(x)) for x in range(0, 100_000, 2)]), [str(ipaddress.IPv4Network(x)) for x in range(0, 100_000, 2)]),
...
@pytest.mark.parametrize("data, sub, expected", [
    ...
    (["40.255.0.0/32", "50.0.0.0/24", "88.184.0.0/13"], ["40.255.0.0/32", "88.188.0.0/14"], ["50.0.0.0/24", "88.184.0.0/14"]),
    (
