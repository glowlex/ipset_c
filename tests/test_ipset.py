...
@pytest.mark.parametrize(
    ...
    [
        ...
        (["240.192.0.0/11", "240.224.0.0/11", "240.224.0.0/13"], ["240.192.0.0/10"]),
        (
            [
                "119.119.4.36/30",
                "119.119.4.32/32",
        ...
        (["0027:e670:478a:ab08:c845:1260:0f8e:ac25/32", "27:e671:478a:ab08:c845:1260:f8e:ac24/32"], ["27:e670::/31"]),
        ...
        (
            (x for x in [str(ipaddress.IPv4Network(x)) for x in range(0, 100_000, 2)]),
            [str(ipaddress.IPv4Network(x)) for x in range(0, 100_000, 2)],
        ),
...
@pytest.mark.parametrize(
    "data, other, expected, expectedGT",
    [
...
@pytest.mark.parametrize(
    "data, other, expected, expectedLT",
    [
        ([], [], True, False),
        ([], ["200.200.77.77/32"], True, True),
        ([], ["0.0.0.0/0"], True, True),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (["8.0.0.0/17", "8.24.0.0/17"], ["8.0.0.0/8"], ["8.0.0.0/8"]),
        ...
        (["130.0.0.0/25", "130.0.0.128/32"], ["130.0.0.128/25"], ["130.0.0.0/24"]),
        (["130.0.0.128/25"], ["130.0.0.0/25", "130.0.0.128/30"], ["130.0.0.0/24"]),
        (
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ["12.22.128.0/20"],
            ["12.22.128.0/24"],
            ["12.22.129.0/24", "12.22.130.0/23", "12.22.132.0/22", "12.22.136.0/21"],
        ),
        (["8.8.0.0/17"], ["8.8.128.0/17"], ["8.8.0.0/16"]),
        (["8.8.0.0/32", "10.8.0.0/32"], ["9.8.128.0/32"], ["8.8.0.0/32", "9.8.128.0/32", "10.8.0.0/32"]),
        (["::/0"], ["::/0"], []),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (["5.5.0.0/16"], ["1.8.0.0/17"], ["5.5.0.0/16"]),
        (
            ["40.255.0.0/32", "50.0.0.0/24", "88.184.0.0/13"],
            ["40.255.0.0/32", "88.188.0.0/14"],
            ["50.0.0.0/24", "88.184.0.0/14"],
        ),
        (
        ...
        (["8.8.8.0/24"], ["8.8.8.128/25", "8.8.8.0/28"], ["8.8.8.16/28", "8.8.8.32/27", "8.8.8.64/26"]),
        (["86.188.140.128", "243.75.103.200"], ["243.75.103.200/29"], ["86.188.140.128/32"]),
